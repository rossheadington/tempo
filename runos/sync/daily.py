...
This is what the launchd LaunchAgent invokes once a day (``runos run-daily``). It
...
* **Garmin stays isolated.** It reuses :func:`runos.sync.pipeline.run_full_sync`,
...
from runos.analysis import fitness
...
from runos.analysis import runner as analysis_runner
from runos.analysis.load import LoadConfig
from runos.analysis.preferences import PreferencesContext, parse_preferences
from runos.analysis.runner import AnalyzeResult, build_load_series
...
class DailyRunResult:
    """The outcome of one ``runos run-daily`` invocation."""
