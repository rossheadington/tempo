...
Day attribution goes through :mod:`tempo.transforms.bucketing` -- the local
...
from tempo.transforms.bucketing import local_day_from_strava_local
from tempo.transforms.coerce import _opt_float, _opt_int, _opt_str
